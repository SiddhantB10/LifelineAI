      ...
      <GlassCard>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {demoEmergencies.length > 0 ? (
            ...
            <div className="col-span-full rounded-2xl border border-white/10 bg-white/5 p-4 text-center text-slate-400">
              <p className="text-sm">No active emergencies in the city. System is monitoring...</p>
            </div>
          )}
        </div>
      </GlassCard>
